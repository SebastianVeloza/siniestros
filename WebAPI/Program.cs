...
builder.Services.AddSwaggerGen(opcion =>
{
    opcion.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Description = "Facilitar la gesti�n y an�lisis de siniestros viales, ofreciendo una API flexible y escalable que pueda integrarse con sistemas de reporte, visualizaci�n o an�lisis estad�stico.",
...
// Usar el middleware JWT para la autenticaci�n
...
public partial class Program { } //Para la pruebas de integraci�n
